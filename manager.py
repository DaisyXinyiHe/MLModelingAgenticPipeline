...
class ManagerAgent():
    ...
    def __init__(self,user_instructions,user_defined_target,csv_path,varb_info_path):
        ...
        self.fea_agent = feature_analysis_Agent(user_instructions = user_instructions, user_defined_target=user_defined_target)
        self.modeling_agent = ModelingAgent()
        self.evaluation_agent = EvaluationAgent(user_instructions = user_instructions,user_defined_target =user_defined_target)
        self.report_agent = ReportAgent(user_instructions = user_instructions,user_defined_target =user_defined_target)
